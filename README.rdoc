...
* jj/pattern -Pattern Library module.  'Pattern' here is also known as 'Intrusive container'.
  This provides several container patterns like List, Tree, and Hash.
  (Graph have not yet been supported).
...
In my case,
* v2.4.6 is installed at Debian Linux 11(bullseye)
* v2.4.7 is installed at Ubuntu 24.04
...
== run configure, make, make install
  ...
  (goto jj-pattern.git/ again)
  $ autoreconf -i
  $ ./configure --prefix=/opt/jj/2.1
  $ make
  $ sudo make install

= Document

Doxygen generated document is {here}[https://doc.wells.blue/jj-pattern/].
